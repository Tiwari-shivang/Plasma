...
import com.example.plasma.HospitalActivity;
import com.example.plasma.R;
import com.example.plasma.RecipientHomePage;

import java.util.ArrayList;

public class hospitalNameAdapterDonor extends RecyclerView.Adapter<hospitalNameAdapterDonor.ViewHolder> {
    ArrayList<String> hospitalNames; Context context; String fragment;
    public hospitalNameAdapterDonor (ArrayList<String> hospitalNames, Context context, String fragment){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder = new ViewHolder(singleHospitalDetail);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(context, DonorsHomePage.class);
